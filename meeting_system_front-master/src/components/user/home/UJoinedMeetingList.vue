...
<template>
  <div>
    <div class="table-header">
      ...
      <el-button type="primary" @click="insertMeetVisible = true  " class="green-button">参加会议</el-button>
    </div>
    ...
    <el-dialog v-model="insertMeetVisible" width="30%" title="参加会议">
      ...
      <template #footer>
        <span class="dialog-footer">
          ...
          <el-button type="primary" @click="insertMeetSumbit()" class="green-button">参加会议</el-button>
        </span>
      </template>
    </el-dialog>
  </div>
