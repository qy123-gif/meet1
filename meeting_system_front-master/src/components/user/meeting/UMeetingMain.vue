...
const upVideoCall = async () => {
  try {
    // 获取摄像头和麦克风流
    vLocalStream = await navigator.mediaDevices.getUserMedia({
      video: true,
    ...
    videoDom.value.muted = true; // 本地视频静音，避免回声
    videoDom.value.play();
    ...
    console.error("无法获取媒体设备权限", error);
    ElMessage.error("无法获取摄像头和麦克风权限");
  }
};
const upAudio = () => {
      ...
      <el-container>
        ...
        <el-main>
          <div class="main_block">
            <div class="video_block" >
              ...
              <div v-show="rtcStarted == -1" class="waitup_block">
                <span class="waitup_msg">暂时还没有人开启视频</span>
              </div>
            </div>
            <div>
          ...
          <div class="turn_button">
            ...
            >
            <el-button @click="startVideoCall">{{ rtcMsg }}</el-button>
